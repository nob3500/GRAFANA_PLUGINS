...
function (_super) {
  ...
  function QueryEditor() {
    ...
    _this.onQueryIndexChange = function (event) {
      var _a = _this.props,
    ...
    _this.onQueryEquipoChange = function (event) {
    ...
    _this.onQueryCamposChange = function (event) {
      var _a = _this.props,
          onChange = _a.onChange,
          query = _a.query;
      onChange(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, query), {
        campos: event.target.value
      }));
    };
  ...
  QueryEditor.prototype.render = function () {
    ...
    return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", {
      ...
      labelWidth: 8,
      value: index || '',
      onChange: this.onQueryIndexChange,
      label: "Index",
      tooltip: "Indices para Elastic Search"
    }), react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(FormField, {
      labelWidth: 8,
      value: equipo || '',
      onChange: this.onQueryEquipoChange,
      label: "Equipo",
      tooltip: "Equipo dentro del indice"
    }), react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(FormField, {
      labelWidth: 8,
      value: campos || '',
      onChange: this.onQueryCamposChange,
      label: "Variables",
      placeholder: "var1,var2,var3",
      tooltip: "variables separado por comas, sin dejara espacios"
    })));
  };
