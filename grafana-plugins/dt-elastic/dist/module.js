...
var QueryEditor = function QueryEditor(_a) {
  ...
  var _b = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__read"])(Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])(index), 2),
      localIndex = _b[0],
      setlocalIndex = _b[1];

  var _c = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__read"])(Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])(equipo), 2),
      localEquipo = _c[0],
      setlocalEquipo = _c[1];

  var _d = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__read"])(Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])(campos), 2),
      localCampos = _d[0],
      setlocalCampos = _d[1];

  var onlocalIndexChange = function onlocalIndexChange(event) {
    return setlocalIndex(event.target.value);
  };

  var onlocalEquipoChage = function onlocalEquipoChage(event) {
    return setlocalEquipo(event.target.value);
  };

  var setTags = function setTags(tags) {
    return setlocalCampos(tags);
  };

  Object(react__WEBPACK_IMPORTED_MODULE_1__["useEffect"])(function () {
    if (localCampos !== undefined) {
      if (localIndex !== '' && localEquipo !== '' && localCampos.length > 0) {
  ...
  }, [localIndex, localEquipo, localCampos, query, onChange]);
  return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
    style: {
      width: '100%'
    }
    ...
    placeholder: "Ingrese el Index",
    value: localIndex,
    css: true,
    onChange: onlocalIndexChange
    ...
    value: localEquipo,
    css: true,
    onChange: onlocalEquipoChage
  }))), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_2__["Label"], {
    description: "Ingreso de campos."
  }, "Campos"), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_2__["TagsInput"], {
    tags: localCampos,
    onChange: setTags
  }));
};
