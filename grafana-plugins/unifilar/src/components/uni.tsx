...
//VARIABLES SISTEMA 1
import { Var15_2, DataTsg1A } from './variables_sist1/var15_2_tsg1A';
import { Var15_1, DataAtssg11A } from './variables_sist1/var15_1_ats_sg_11A';
...
type Unifilar = {
  ...
  dataRec01A: DataRec01A,
  dataTupsin01A: DataTupsin01A,
  dataTupsout01A: DataTupsout01A ,
  dataAtspdu09A: DataAtspdu09A,
  dataTpdu01A: DataTpdu01A,
  dataAtschi07A: DataAtschi07A,
  dataTchi03A: DataTchi03A,
  dataTchi01A: DataTchi01A,
  dataLine_sist1 : DataLine_sist1,
  dataatssg11A: DataAtssg11A,
  datatsg1A: DataTsg1A,
  dataDieselS2: DataDieselS2,
  dataAts04A: DataAts04A,
  dataTdp02A: DataTdp02A,
  dataAtsantsat2A: DataAtsantsat2A,
  dataAtsrec06A: DataAtsrec06A,
  dataRec02A: DataRec02A,
  dataTupsin02A: DataTupsin02A,
  dataTupsout02A: DataTupsout02A,
  dataAtspdu10A: DataAtspdu10A,
  dataTpdu02A: DataTpdu02A,
  dataAtschi08A: DataAtschi08A,
  dataTchi04A: DataTchi04A,
  dataTchi02A: DataTchi02A,
  dataLine_sist2: DataLine_sist2,
  dataAts03A : DataAts03A,
  dataTdp01A: DataTdp01A,
  dataAtsantsat1A: DataAtsantsat1A
}

export interface DataUnifilar {
  unifilar: Unifilar
}
...
const uni = ({ unifilar }: DataUnifilar) => {
  ...
  >
    ...
    <Var15_2
      tsg_1A = {unifilar.datatsg1A.tsg_1A}
    />

    <Var15_1
      ats_sg11A = {unifilar.dataatssg11A.ats_sg11A}
    />
    <VartdlowA
    ...
    <Var1
      psg_1A_2A = {unifilar.dataPSG_1A_2A.psg_1A_2A}
    />

    <Var2
      diesels1 = {unifilar.dataDieselS1.diesels1}
    />
    
    <Var3
      ats03A = {unifilar.dataAts03A.ats03A}
    />

    <Var4
      tdp01A = {unifilar.dataTdp01A.tdp01A}
    />

    <Var5
      atsantsat1A = {unifilar.dataAtsantsat1A.atsantsat1A}
    />

    <Var6
      atsrec05A = {unifilar.dataAtsrec05A.atsrec05A}
    />

    <Var7
      rec01A = {unifilar.dataRec01A.rec01A}
    />

    <Var8
      tupsin01A = {unifilar.dataTupsin01A.tupsin01A}
    />

    <Var9
      tupsout01A = {unifilar.dataTupsout01A.tupsout01A}
    />

    <Var10
      atspdu09A = {unifilar.dataAtspdu09A.atspdu09A}    
    />

    <Var11
      tpdu01A = {unifilar.dataTpdu01A.tpdu01A}       
    />

    <Var12
      atschi07A = {unifilar.dataAtschi07A.atschi07A}
    />
    <Var13
      tchi03A = {unifilar.dataTchi03A.tchi03A}
    />
    <Var14
      tchi01A = {unifilar.dataTchi01A.tchi01A}
    />
    <Var15
      lineas_sistema1 = {unifilar.dataLine_sist1.lineas_sistema1}    
    />
    <Var16
      diesels2 = {unifilar.dataDieselS2.diesels2}
    />
    <Var17
      ats04A = {unifilar.dataAts04A.ats04A}
    />
    <Var18
      tdp02A = {unifilar.dataTdp02A.tdp02A}
    />
    <Var19
      atsantsat2A = {unifilar.dataAtsantsat2A.atsantsat2A}
    />
    <Var20 
      atsrec06A = {unifilar.dataAtsrec06A.atsrec06A}
    />
    <Var21 
      rec02A = {unifilar.dataRec02A.rec02A}
    />
    <Var22
      tupsin02A = {unifilar.dataTupsin02A.tupsin02A}
    />
    <Var23
      tupsout02A = {unifilar.dataTupsout02A.tupsout02A}
    />
    <Var24
      atspdu10A = {unifilar.dataAtspdu10A.atspdu10A}
    />
    <Var25
      tpdu02A = {unifilar.dataTpdu02A.tpdu02A}
    />

    <Var26
      atschi08A = {unifilar.dataAtschi08A.atschi08A}
    />
    <Var27
      tchi04A = {unifilar.dataTchi04A.tchi04A}
    />
    <Var28
      tchi02A = {unifilar.dataTchi02A.tchi02A}
    />
    <Var29
      lineas_sistema2 = {unifilar.dataLine_sist2.lineas_sistema2}
    />
