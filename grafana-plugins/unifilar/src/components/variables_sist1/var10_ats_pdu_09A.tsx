...
//className = {atspdu09A.atspdu09A_F2}
    ...
    atspdu09A_F1:    string;//ellipse19634-70
    atspdu09A_tri1:  string;//path11127-1 
}
export interface DataAtspdu09A{
  
  atspdu09A: ATS_PDU_09A; 
...
export const Var10 = ({
    ...
    return (
        //Se inserta GRupo del tablero DataAtspdu09A
      ...
      <g id="g6182-3">
        ...
        >
          ...
          <ellipse
            ...
            ry={11.275}
            fill="#999"
            className = {atspdu09A.atspdu09A_F1}
          />
          <text
          ...
          <path
            ...
            fill="#0f0"
            className ={atspdu09A.atspdu09A_tri2}
          />
          <path
            id="path11127-1"
            d="M347.43 310.52l.491 18.094 18.677-10.052z"
            fill="#999"
            className ={atspdu09A.atspdu09A_tri1}
          />
        </g>
        <text
