...
const dataGenerador = (data: PanelData, options: SimpleOptions): DataGenerador => {
  ...
  let MANUAL_MODE = data.series.find(({ name }) => name?.includes('DATA.MANUAL_MODE.VALUE'))?.fields[1].state?.calcs?.lastNotNull
  let STOP_MODE = data.series.find(({ name }) => name?.includes('DATA.STOP_MODE.VALUE'))?.fields[1].state?.calcs?.lastNotNull
  let AUTO_MODE = data.series.find(({ name }) => name?.includes('DATA.AUTO_MODE.VALUE'))?.fields[1].state?.calcs?.lastNotNull
  let OFF_MODE = data.series.find(({ name }) => name?.includes('DATA.OFF_MODE.VALUE'))?.fields[1].state?.calcs?.lastNotNull
  let L1L2_VOL = data.series.find(({ name }) => name?.includes('DATA.L1L2_VOL.VALUE'))?.fields[1].state?.calcs?.lastNotNull
  let L2L3_VOL = data.series.find(({ name }) => name?.includes('DATA.L2L3_VOL.VALUE'))?.fields[1].state?.calcs?.lastNotNull
  let L3L1_VOL = data.series.find(({ name }) => name?.includes('DATA.L3L1_VOL.VALUE'))?.fields[1].state?.calcs?.lastNotNull
  let L1N_VOL = data.series.find(({ name }) => name?.includes('DATA.L1N_VOL.VALUE'))?.fields[1].state?.calcs?.lastNotNull
  let L2N_VOL = data.series.find(({ name }) => name?.includes('DATA.L2N_VOL.VALUE'))?.fields[1].state?.calcs?.lastNotNull
  let L3N_VOL = data.series.find(({ name }) => name?.includes('DATA.L3N_VOL.VALUE'))?.fields[1].state?.calcs?.lastNotNull
  ...
  let TOT_WATTS = data.series.find(({ name }) => name?.includes('DATA.TOT_WATTS.VALUE'))?.fields[1].state?.calcs?.lastNotNull
  let FREQ = data.series.find(({ name }) => name?.includes('DATA.FREQ.VALUE'))?.fields[1].state?.calcs?.lastNotNull
  let FUEL_LEV = data.series.find(({ name }) => name?.includes('DATA.FUEL_LEV.VALUE'))?.fields[1].state?.calcs?.lastNotNull
  let OIL_PRESS = data.series.find(({ name }) => name?.includes('DATA.OIL_PRESS.VALUE'))?.fields[1].state?.calcs?.lastNotNull
  let COOL_TEMP = data.series.find(({ name }) => name?.includes('DATA.COOL_TEMP.VALUE'))?.fields[1].state?.calcs?.lastNotNull
  let ENG_BATT_VOL = data.series.find(({ name }) => name?.includes('DATA.ENG_BATT_VOL.VALUE'))?.fields[1].state?.calcs?.lastNotNull
  let ENG_RUN_TIME = data.series.find(({ name }) => name?.includes('DATA.ENG_RUN_TIME.VALUE'))?.fields[1].state?.calcs?.lastNotNull
  let MODBUS_ST = data.series.find(({ name }) => name?.includes('DATA.MODBUS_ST.VALUE'))?.fields[1].state?.calcs?.lastNotNull
  let WARNING_ST = data.series.find(({ name }) => name?.includes('DATA.WARNING_ST.VALUE'))?.fields[1].state?.calcs?.lastNotNull
  let ES_ELTRIP_ALM = data.series.find(({ name }) => name?.includes('DATA.ES_ELTRIP_ALM.VALUE'))?.fields[1].state?.calcs?.lastNotNull
  let ES_SHUTD_ALM = data.series.find(({ name }) => name?.includes('DATA.ES_SHUTD_ALM.VALUE'))?.fields[1].state?.calcs?.lastNotNull
  let ES_WARN_ALM = data.series.find(({ name }) => name?.includes('DATA.ES_WARN_ALM.VALUE'))?.fields[1].state?.calcs?.lastNotNull
  let FS_ELTRIP_ALM = data.series.find(({ name }) => name?.includes('DATA.FS_ELTRIP_ALM.VALUE'))?.fields[1].state?.calcs?.lastNotNull
  let FS_SHUTD_ALM = data.series.find(({ name }) => name?.includes('DATA.FS_SHUTD_ALM.VALUE'))?.fields[1].state?.calcs?.lastNotNull
  let FS_WARN_ALM = data.series.find(({ name }) => name?.includes('DATA.FS_WARN_ALM.VALUE'))?.fields[1].state?.calcs?.lastNotNull
  let GHV_ELTRIP_ALM = data.series.find(({ name }) => name?.includes('DATA.GHV_ELTRIP_ALM.VALUE'))?.fields[1].state?.calcs?.lastNotNull
  let GHV_SHUTD_ALM = data.series.find(({ name }) => name?.includes('DATA.GHV_SHUTD_ALM.VALUE'))?.fields[1].state?.calcs?.lastNotNull
  let GHV_WARN_ALM = data.series.find(({ name }) => name?.includes('DATA.GHV_WARN_ALM.VALUE'))?.fields[1].state?.calcs?.lastNotNull
  let GLV_ELTRIP_ALM = data.series.find(({ name }) => name?.includes('DATA.GLV_ELTRIP_ALM.VALUE'))?.fields[1].state?.calcs?.lastNotNull
  let GLV_SHUTD_ALM = data.series.find(({ name }) => name?.includes('DATA.GLV_SHUTD_ALM.VALUE'))?.fields[1].state?.calcs?.lastNotNull
  let GLV_WARN_ALM = data.series.find(({ name }) => name?.includes('DATA.GLV_WARN_ALM.VALUE'))?.fields[1].state?.calcs?.lastNotNull
  let HCT_ELTRIP_ALM = data.series.find(({ name }) => name?.includes('DATA.HCT_ELTRIP_ALM.VALUE'))?.fields[1].state?.calcs?.lastNotNull
  let HCT_SHUTD_ALM = data.series.find(({ name }) => name?.includes('DATA.HCT_SHUTD_ALM.VALUE'))?.fields[1].state?.calcs?.lastNotNull
  let HCT_WARN_ALM = data.series.find(({ name }) => name?.includes('DATA.HCT_WARN_ALM.VALUE'))?.fields[1].state?.calcs?.lastNotNull
  let LOP_ELTRIP_ALM = data.series.find(({ name }) => name?.includes('DATA.LOP_ELTRIP_ALM.VALUE'))?.fields[1].state?.calcs?.lastNotNull
  let LOP_SHUTD_ALM = data.series.find(({ name }) => name?.includes('DATA.LOP_SHUTD_ALM.VALUE'))?.fields[1].state?.calcs?.lastNotNull
  let LOP_WARN_ALM = data.series.find(({ name }) => name?.includes('DATA.LOP_WARN_ALM.VALUE'))?.fields[1].state?.calcs?.lastNotNull
  let OS_ELTRIP_ALM = data.series.find(({ name }) => name?.includes('DATA.OS_ELTRIP_ALM.VALUE'))?.fields[1].state?.calcs?.lastNotNull
  let OS_WARN_ALM = data.series.find(({ name }) => name?.includes('DATA.OS_WARN_ALM.VALUE'))?.fields[1].state?.calcs?.lastNotNull
  let OS_SHUTD_ALM = data.series.find(({ name }) => name?.includes('DATA.OS_SHUTD_ALM.VALUE'))?.fields[1].state?.calcs?.lastNotNull
  let US_ELTRIP_ALM = data.series.find(({ name }) => name?.includes('DATA.US_ELTRIP_ALM.VALUE'))?.fields[1].state?.calcs?.lastNotNull
  let US_SHUTD_ALM = data.series.find(({ name }) => name?.includes('DATA.US_SHUTD_ALM.VALUE'))?.fields[1].state?.calcs?.lastNotNull
  let US_WARN_ALM = data.series.find(({ name }) => name?.includes('DATA.US_WARN_ALM.VALUE'))?.fields[1].state?.calcs?.lastNotNull
