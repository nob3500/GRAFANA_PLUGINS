import { ApplyFieldOverrideOptions, DataFrame, DataSourceInstanceSettings, DynamicConfigValue, Field, FieldConfig, FieldOverrideContext, GrafanaTheme, InterpolateFunction, LinkModel, ScopedVars, TimeZone, ValueLinkConfig } from '../types';
...
export declare const getLinksSupplier: (frame: DataFrame, field: Field, fieldScopedVars: ScopedVars, replaceVariables: InterpolateFunction, getDataSourceSettingsByUid: (uid: string) => DataSourceInstanceSettings | undefined, options: {
    theme: GrafanaTheme;
    timeZone?: TimeZone;
