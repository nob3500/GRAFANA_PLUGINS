...
import IN_VOL_MAX from 'components/IN_VOL_MAX';
import OUT_TOTAL from 'components/OUT_TOTAL';
import OUT_TOT_KW from 'components/OUT_TOT_KW';
import DATOS_GENERALES from 'components/DATOS_GENERALES';
import ALARMAS from 'components/ALARMAS';
import ESTADOS from 'components/ESTADOS';
import ESTADO_PRINCIPAL from 'components/ESTADO_PRINCIPAL';
      ...
      >
        <defs id="defs3489">
          ...
          <linearGradient id="linearGradient4372">
            <stop id="stop4368" offset="0" stopColor="#ff0"></stop>
            <stop id="stop4370" offset="1"></stop>
          </linearGradient>
          <linearGradient
          ...
          <linearGradient id="linearGradient15175">
            <stop id="stop15171" offset="0" stopColor="#178497"></stop>
          ...
          <filter id="filter15827" width="1.048" height="1.048" x="-0.024" y="-0.024" colorInterpolationFilters="sRGB">
            <feGaussianBlur id="feGaussianBlur15829" stdDeviation="1.339"></feGaussianBlur>
          </filter>
          <filter id="filter15839" width="1.012" height="1.012" x="-0.006" y="-0.006" colorInterpolationFilters="sRGB">
            <feGaussianBlur id="feGaussianBlur15841" stdDeviation="0.304"></feGaussianBlur>
          </filter>
          <filter id="filter2711" width="1.047" height="1.049" x="-0.024" y="-0.024" colorInterpolationFilters="sRGB">
            <feGaussianBlur id="feGaussianBlur2713" stdDeviation="0.135"></feGaussianBlur>
          </filter>
          ...
          <filter id="filter2715" width="1.091" height="1.102" x="-0.045" y="-0.051" colorInterpolationFilters="sRGB">
            <feGaussianBlur id="feGaussianBlur2717" stdDeviation="0.348"></feGaussianBlur>
          </filter>
          <filter id="filter2675" width="1.146" height="1.029" x="-0.073" y="-0.014" colorInterpolationFilters="sRGB">
            <feGaussianBlur id="feGaussianBlur2677" stdDeviation="0.064"></feGaussianBlur>
          </filter>
          <filter id="filter9199" width="1.023" height="1.025" x="-0.012" y="-0.012" colorInterpolationFilters="sRGB">
            <feGaussianBlur id="feGaussianBlur9201" stdDeviation="0.032"></feGaussianBlur>
          </filter>
          <filter id="filter9203" width="1.017" height="1.042" x="-0.008" y="-0.021" colorInterpolationFilters="sRGB">
            <feGaussianBlur id="feGaussianBlur9205" stdDeviation="0.023"></feGaussianBlur>
          </filter>
          <filter id="filter9179" width="1.022" height="1.027" x="-0.011" y="-0.013" colorInterpolationFilters="sRGB">
            <feGaussianBlur id="feGaussianBlur9181" stdDeviation="0.025"></feGaussianBlur>
          </filter>
          <filter id="filter9183" width="1.016" height="1.047" x="-0.008" y="-0.024" colorInterpolationFilters="sRGB">
            <feGaussianBlur id="feGaussianBlur9185" stdDeviation="0.022"></feGaussianBlur>
          </filter>
          <filter id="filter9191" width="1.022" height="1.026" x="-0.011" y="-0.013" colorInterpolationFilters="sRGB">
            <feGaussianBlur id="feGaussianBlur9193" stdDeviation="0.032"></feGaussianBlur>
          </filter>
          <filter id="filter8922" width="1.026" height="1.022" x="-0.013" y="-0.011" colorInterpolationFilters="sRGB">
            <feGaussianBlur id="feGaussianBlur8924" stdDeviation="0.605"></feGaussianBlur>
          </filter>
          <filter id="filter21713" width="1.13" height="1.112" x="-0.065" y="-0.056" colorInterpolationFilters="sRGB">
            <feGaussianBlur id="feGaussianBlur21715" stdDeviation="0.033"></feGaussianBlur>
          </filter>
          <filter id="filter21739" width="1.184" height="1.2" x="-0.092" y="-0.1" colorInterpolationFilters="sRGB">
            <feGaussianBlur id="feGaussianBlur21741" stdDeviation="0.067"></feGaussianBlur>
          </filter>
          <clipPath id="clipPath1163-2">
            <path
              id="path1165-5"
              fill="none"
              stroke="#000"
          ...
          <filter
            ...
            colorInterpolationFilters="sRGB"
          >
            <feGaussianBlur id="feGaussianBlur15439-0" stdDeviation="0.203"></feGaussianBlur>
          </filter>
          <filter
            id="filter15337-3"
            width="1.154"
            ...
            colorInterpolationFilters="sRGB"
          >
            <feGaussianBlur id="feGaussianBlur15339-3" stdDeviation="0.202"></feGaussianBlur>
          </filter>
          <filter
            id="filter15401-1"
            width="1.154"
            ...
            colorInterpolationFilters="sRGB"
          >
            <feGaussianBlur id="feGaussianBlur15403-7" stdDeviation="0.203"></feGaussianBlur>
          </filter>
          <clipPath id="clipPath2072-7">
            <path
              id="path2074-3"
              fill="none"
              stroke="#000"
          ...
          <filter
            ...
            colorInterpolationFilters="sRGB"
          >
            <feGaussianBlur id="feGaussianBlur21613-4" stdDeviation="0.059"></feGaussianBlur>
          </filter>
          <filter
            id="filter21601-3"
            width="1.064"
            ...
            colorInterpolationFilters="sRGB"
          >
            <feGaussianBlur id="feGaussianBlur21603-0" stdDeviation="0.046"></feGaussianBlur>
          </filter>
          ...
          <filter id="filter21344" width="1.058" height="1.041" x="-0.029" y="-0.02" colorInterpolationFilters="sRGB">
            <feGaussianBlur id="feGaussianBlur21346" stdDeviation="0.066"></feGaussianBlur>
          </filter>
          <filter id="filter21324" width="1.025" height="1.023" x="-0.013" y="-0.011" colorInterpolationFilters="sRGB">
            <feGaussianBlur id="feGaussianBlur21326" stdDeviation="0.009"></feGaussianBlur>
          </filter>
          <filter id="filter21328" width="1.205" height="1.027" x="-0.102" y="-0.014" colorInterpolationFilters="sRGB">
            <feGaussianBlur id="feGaussianBlur21330" stdDeviation="0.059"></feGaussianBlur>
          </filter>
          <filter id="filter21336" width="1.028" height="1.171" x="-0.014" y="-0.086" colorInterpolationFilters="sRGB">
            <feGaussianBlur id="feGaussianBlur21338" stdDeviation="0.063"></feGaussianBlur>
          </filter>
          <filter
            id="filter2963-9-74"
            width="1.213"
            ...
            colorInterpolationFilters="sRGB"
          >
            <feGaussianBlur id="feGaussianBlur2965-8-4" stdDeviation="0.168"></feGaussianBlur>
          </filter>
          <filter
            id="filter2963-9-6"
            width="1.213"
            ...
            colorInterpolationFilters="sRGB"
          >
            <feGaussianBlur id="feGaussianBlur2965-8-5" stdDeviation="0.168"></feGaussianBlur>
          </filter>
          <filter
            id="filter2963-9-7"
            width="1.213"
            ...
            colorInterpolationFilters="sRGB"
          >
            <feGaussianBlur id="feGaussianBlur2965-8-3" stdDeviation="0.168"></feGaussianBlur>
          </filter>
          <filter id="filter2963-9" width="1.213" height="1.262" x="-0.107" y="-0.131" colorInterpolationFilters="sRGB">
            <feGaussianBlur id="feGaussianBlur2965-8" stdDeviation="0.168"></feGaussianBlur>
          </filter>
          ...
          <linearGradient
            ...
            xlinkHref="#linearGradient4372"
          ></linearGradient>
          <filter id="filter21344-2" width="1.058" height="1.041" x="-0.029" y="-0.02" colorInterpolationFilters="sRGB">
            <feGaussianBlur id="feGaussianBlur21346-9" stdDeviation="0.066"></feGaussianBlur>
          </filter>
          <filter
            id="filter21324-0"
            width="1.025"
            ...
            colorInterpolationFilters="sRGB"
          >
            <feGaussianBlur id="feGaussianBlur21326-6" stdDeviation="0.009"></feGaussianBlur>
          </filter>
          <filter
            id="filter21328-6"
            width="1.205"
            ...
            colorInterpolationFilters="sRGB"
          >
            <feGaussianBlur id="feGaussianBlur21330-4" stdDeviation="0.059"></feGaussianBlur>
          </filter>
          <filter
            id="filter21336-9"
            width="1.028"
        ...
        <g id="layer1" transform="translate(0 -11.25)">
          <rect id="rect3497" width="507.81" height="199.85" x="0.008" y="11.256" rx="0.217"></rect>
          <g id="g21364" transform="translate(3.257 -2.13)">
            <path
              id="path21298"
              fill="#168498"
              stroke="#0deff7"
            ...
            <g id="g21353">
              ...
              <path
                ...
                opacity="0.8"
              ></path>
              <path id="path21310" fill="none" stroke="#00aad4" strokeWidth="0.2" d="M22.357 115.16v7.508"></path>
              <path
                id="path21312"
                fill="none"
                stroke="#00aad4"
          ...
          <g id="g21797" transform="translate(29.218 -8.48)">
            <path
              id="path21605"
              fill="none"
              stroke="#0deff7"
          ...
          ></path>
          <g id="g2200" fill="none" stroke="#0deff7" transform="translate(0 11.25)">
            <path
              id="path15283-5"
              strokeWidth="0.768"
              d="M397.85 14.095l4.798-2.037h59.077l4.948 1.897v11.52l-4.423 1.79h-60.351l-4.31-1.808.262-11.362"
            ></path>
            <path id="path15285-8" strokeWidth="0.802" d="M395.2 12.279l5.004-2.997h3.786"></path>
            <path id="path15287-5" strokeWidth="0.884" d="M468.88 11.916l-6.146-2.964h-4.65"></path>
            <path id="path15289-5" strokeWidth="0.884" d="M395.9 26.474l5.819 2.9 61.505.28 5.213-3.124"></path>
          </g>
          <path
            id="path15297-5"
            fill="#0deff7"
          ...
          ></path>
          <g id="g11134" transform="matrix(.82951 0 0 .69041 -68.481 15.609)">
            <path id="path15281-1" fill="#17d8fb" d="M88.487 12.957l7.519.05-7.356 4.114z"></path>
            <path
              id="path15277-6"
              fill="none"
              stroke="#0deff7"
          ...
          ></image>
          <g id="g6127" fill="#168498" stroke="#0deff7" transform="scale(-1 1) rotate(4.794 -1185.647 -6367.795)">
            <path id="path6121" strokeWidth="0.618" d="M266.21 91.248l-12.621 12.458"></path>
            <path id="path6123" strokeWidth="0.289" d="M260.94 92.702l-6.212 5.99"></path>
            <path id="path6125" strokeWidth="0.289" d="M263.63 97.34l-4.455 4.302"></path>
          </g>
          <g id="g6215" fill="#168498" stroke="#0deff7" transform="matrix(-.7497 .09649 .09649 .7497 561.91 25.938)">
            <path id="path6207" strokeWidth="0.618" d="M260.44 88.374l-12.621 12.459"></path>
            <path id="path6209" strokeWidth="0.289" d="M255.17 89.828l-6.212 5.99"></path>
            <path id="path6211" strokeWidth="0.289" d="M257.86 94.466l-4.455 4.302"></path>
            <path id="path6213" strokeWidth="0.289" d="M257.86 94.466l-4.455 4.302"></path>
          </g>
          <path
            id="path6170-7"
          ...
          <g id="g5158">
            ...
            ></path>
            <g id="g11106" stroke="#c19b00" strokeOpacity="0.988" transform="matrix(0 -.89617 1.0649 0 283.45 203.35)">
              <path
                id="path11096"
                fill="#d4aa00"
                strokeWidth="0.2"
              ...
              <path
                ...
                opacity="0.8"
              ></path>
              <path id="path11100" fill="none" strokeWidth="0.2" d="M22.357 115.16v7.508"></path>
              <path
                id="path11102"
                fill="none"
                strokeWidth="0.2"
